...
<ol>
<li>在客户端中选择“新建映射”；</li>
<li>设置映射名称，如：项目名称 + xxx；</li>
<li>类型选择 <code v-pre>域名解析</code>；</li>
<li>设置本地Ip:端口（例如：127.0.0.1:8080）；</li>
<li>点击确定即可。即可通过公网访问本地网站。</li>
</ol>
<blockquote>
<p>💡 外网访问地址，将自动生成</p>
</blockquote>
...
<ol>
<li>创建新映射，类型选择 <code v-pre>TCP</code>；</li>
...
<ol>
<li>创建映射类型为 <code v-pre>TCP</code>；</li>
